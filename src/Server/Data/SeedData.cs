...
public static class SeedData
{
    ...
    private static void SeedMenuItems(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<MenuItem>().HasData(
            Mi(MiBowl, CatBowls, "Burrito Bowl", "Build your own bowl", true, 1, "/menu/burrito-bowl.jpg", true),
            Mi(MiDrip, CatDrinks, "Drip Coffee", "Fresh batch brew", false, 1, "/menu/drip-coffee.jpg", true),
            Mi(MiAuLait, CatDrinks, "Café au Lait", "½ drip + ½ steamed milk", false, 2, "/menu/cafe-au-lait.jpg", true),
            Mi(MiEspresso, CatDrinks, "Espresso", "Shot of espresso", false, 3, "/menu/espresso.jpg", true),
            Mi(MiAmericano, CatDrinks, "Americano", "Espresso + hot water", false, 4, "/menu/americano.jpg", true),
            Mi(MiCaraMac, CatDrinks, "Caramel Macchiato", "Layered caramel espresso drink", false, 5, "/menu/caramel-macchiato.jpg", true),
            Mi(MiCortado, CatDrinks, "Cortado", "1:1 espresso : steamed milk", false, 6, "/menu/cortado.jpg", true),
            Mi(MiCappuccino, CatDrinks, "Cappuccino", "Espresso + airy foam", false, 7, "/menu/cappuccino.jpg", true),
            Mi(MiLatte, CatDrinks, "Latte", "Espresso + steamed milk", false, 8, "/menu/latte.jpg", true),
            Mi(MiMocha, CatDrinks, "Mocha", "Latte + chocolate syrup", false, 9, "/menu/mocha.jpg", true),
            Mi(MiWhtMocha, CatDrinks, "White Mocha", "Latte + white chocolate syrup", false, 10, "/menu/white-mocha.jpg", true),
            Mi(MiFlvLatte, CatDrinks, "Flavored Latte", "Latte + flavored syrup", false, 11, "/menu/flavored-latte.jpg", true),
            Mi(MiCaraLatte, CatDrinks, "Caramel Latte", "Latte + caramel syrup", false, 12, "/menu/caramel-latte.jpg", true),
            Mi(MiIcedCoffee, CatDrinks, "Iced Coffee", "Chilled drip over ice", false, 13, "/menu/iced-coffee.jpg", true),
            Mi(MiColdBrew, CatDrinks, "Cold Brew", "16-18 hr brew, over ice", false, 14, "/menu/cold-brew.jpg", true),
            Mi(MiIcedLatte, CatDrinks, "Iced Latte", "Espresso + milk over ice", false, 15, "/menu/iced-latte.jpg", true),
            Mi(MiAffogato, CatDrinks, "Affogato", "Espresso over vanilla ice cream", false, 16, "/menu/affogato.jpg", true),
            Mi(MiBlendMocha, CatDrinks, "Blended Mocha", "Espresso, milk, chocolate, ice", false, 17, "/menu/blended-mocha.jpg", true),
            Mi(MiBlendCaramel, CatDrinks, "Blended Caramel", "Espresso, milk, caramel, ice", false, 18, "/menu/blended-caramel.jpg", true),
            Mi(MiSmoothie, CatDrinks, "Smoothie", "Smoothie base + fruit flavor", false, 19, "/menu/smoothie.jpg", true),
            Mi(MiHotChoc, CatDrinks, "Hot Chocolate", "Steamed milk + chocolate", false, 20, "/menu/hot-chocolate.jpg", true),
            Mi(MiSteamer, CatDrinks, "Steamer", "Steamed milk + syrup", false, 21, "/menu/steamer.jpg", true),
            Mi(MiTea, CatDrinks, "Tea", "Premium sachet or pot", false, 22, "/menu/tea.jpg", true),
            Mi(MiChaiLatte, CatDrinks, "Chai Latte", "Chai + steamed milk", false, 23, "/menu/chai-latte.jpg", true),
            Mi(MiPumpkin, CatSeasonal, "Pumpkin Spice Latte", "Latte + pumpkin spice syrup + whipped cream", false, 1, "/menu/pumpkin-spice-latte.jpg", true),
            Mi(MiMaple, CatSeasonal, "Maple Brown Sugar Latte", "Latte + maple brown sugar syrup + whipped cream", false, 2, "/menu/maple-brown-sugar-latte.jpg", true),
            Mi(MiMarshmallow, CatSeasonal, "Toasted Marshmallow Mocha", "Mocha + toasted marshmallow syrup", false, 3, "/menu/toasted-marshmallow-mocha.jpg", true),
            Mi(MiPepMocha, CatSeasonal, "Peppermint Mocha", "Mocha + peppermint syrup + whipped cream", false, 4, "/menu/peppermint-mocha.jpg", true),
            Mi(MiGingerbread, CatSeasonal, "Gingerbread Latte", "Latte + gingerbread syrup", false, 5, "/menu/gingerbread-latte.jpg", true),
            Mi(MiAppleCider, CatSeasonal, "Hot Apple Cider", "Steamed cider + cinnamon", false, 6, "/menu/apple-cider.jpg", true),
            Mi(MiChips, CatSides, "Side of Chips", null, false, 1, "/menu/chips.jpg", true),
            Mi(MiChipsQueso, CatSides, "Chips & Salsa with 13oz Large Queso", null, false, 2, "/menu/chips-queso.jpg", true),
    ...
    private static MenuItem Mi(Guid id, Guid categoryId, string name, string? desc, bool customizable, int sort, string? imageUrl = null, bool imageApproximate = false) => new()
    {
        Id = id, Categoryid = categoryId, Name = name, Description = desc,
        ImageUrl = imageUrl, ImageApproximate = imageApproximate,
